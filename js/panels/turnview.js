...
registerPanel('turnview', {
  ...
  // Both live in js/core/utils.js — this parser had a byte-identical twin in
  // the Attack Runner, and the two panels have to agree about what "2d6+3"
  // means or the same attack rolls differently depending on where you click.
