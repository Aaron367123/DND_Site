...
const BUILD = '53785c9cc1';
const PRECACHE = [
  'skt-workspace.html',
  'styles/main.css?v=65723a776f',
  ...
  'js/panels/turnview.js?v=9a4a6ea522',
  'js/panels/party.js?v=0fb5be7338',
  'js/panels/shop.js?v=b2a5e212a4',
  ...
  'js/panels/battlemap.js?v=5261aa4ea3',
  ...
  'js/player/player-app.js?v=6374e9ccb6',
  'js/ui/player-view.js?v=7519877ed8',
  'js/sync/realtime.js?v=de6afd8063',
