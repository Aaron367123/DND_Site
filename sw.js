...
const BUILD = 'f39ea87132';
const PRECACHE = [
  'skt-workspace.html',
  'styles/main.css?v=ed1af27bdf',
  'js/core/errors.js?v=67c70f2e1d',
  'js/core/data.js?v=6dc8428695',
  'js/core/theme.js?v=533ffb6fb1',
  'js/core/asset-config.js?v=9b018a4988',
  'js/generated/token-index.js?v=e043a461be',
  'js/core/utils.js?v=b3488668a0',
  'js/core/state.js?v=dbbd331c36',
  'js/core/window-manager.js?v=54923214c2',
  'js/panels/combat.js?v=7e1742854c',
  'js/panels/attacks.js?v=8432f5f81d',
  'js/panels/party.js?v=d868d7936f',
  'js/panels/shop.js?v=3edd9aa468',
  'js/sync/notes-sync.js?v=8c42540638',
  'js/sync/dropbox-config.js?v=ccf8533d50',
  'js/sync/dropbox-sync.js?v=ab773edfd6',
  'js/panels/notes.js?v=af095b4baa',
  'js/panels/battlemap.js?v=41cbbf1ad1',
  'js/panels/npc-library.js?v=6986b9c7c2',
  'js/panels/bestiary.js?v=2fe0a694ab',
  'js/panels/content-panel.js?v=4d5ee5f31a',
  'js/panels/adventures.js?v=adbf195007',
  'js/panels/books.js?v=beba2c9cfd',
  'js/panels/npc-generator.js?v=b93335dc60',
  'js/panels/loot.js?v=d789dc97dc',
  'js/panels/encounter.js?v=8ae3629311',
  'js/panels/soundboard.js?v=c345ae84db',
  'js/panels/weather.js?v=ab1bd498ab',
  'js/panels/timetracker.js?v=94543d2fa7',
  'js/content/data-loader.js?v=7bd91b7bcf',
  'js/content/search.js?v=6eaa5d18fe',
  'js/features/backup.js?v=748e46a5d8',
  'js/ui/settings.js?v=19cb2d3859',
  'js/ui/context-menu.js?v=32564cc96d',
  'js/ui/zoom-pan.js?v=31a2882b02',
  'js/ui/workspaces.js?v=bdaf579267',
  'js/features/pdf-import.js?v=d8c25ed1b9',
  'js/ui/player-view.js?v=f6632400cc',
  'js/sync/realtime.js?v=86e367bc57',
