...
const BUILD = 'c7239f852c';
const PRECACHE = [
  'skt-workspace.html',
  'styles/main.css?v=1326c8eb2b',
  ...
  'js/panels/turnview.js?v=16453cbcc0',
  'js/panels/party.js?v=7e061c63ce',
  ...
  'js/player/player-app.js?v=52ee32d7c6',
